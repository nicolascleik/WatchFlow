...
public interface TmdbFeignClient {
    ...
    TmdbMediaResponse buscarDetalhesFilme(@PathVariable("movie_id") Long id, @RequestParam("api_key") String apiKey, @RequestParam("language") String idioma);
    ...
    @GetMapping("/tv/{tv_id}")
    TmdbMediaResponse buscarDetalhesSerie(@PathVariable("tv_id") Long id, @RequestParam("api_key") String apiKey, @RequestParam("language") String idioma);
